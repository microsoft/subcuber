...
using EpilogueOp = cutlass::epilogue::thread::StrassenLinearCombination<double, 1, double, double>;
using InterimEpilogueOp = cutlass::epilogue::thread::StrassenLinearCombination<double, 2, double, double>;
...
using AmpereF64SWInterleavedPresumLevel1_64x64Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
                                                                                                                double, RowMajor, double, RowMajor, double, RowMajor, double,
...
class AmpereF64SWInterleavedPresumLevel1_64x64 {
public:
    using StrassenGemmKernel = AmpereF64SWInterleavedPresumLevel1_64x64Kernel;
