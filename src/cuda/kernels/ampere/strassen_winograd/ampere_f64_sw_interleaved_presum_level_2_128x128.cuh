...
using AmpereF64SWInterleavedPresumLevel2_128x128Kernel = cutlass::gemm::device::StrassenGemmLevel2<StrassenKind,
...
class AmpereF64SWInterleavedPresumLevel2_128x128 {
public:
    using StrassenGemmKernel = AmpereF64SWInterleavedPresumLevel2_128x128Kernel;
