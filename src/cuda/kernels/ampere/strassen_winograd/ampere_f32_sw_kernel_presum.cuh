...
using AmpereF32SWKernelPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class AmpereF32SWKernelPresumLevel1 {
public:
  using StrassenGemmKernel = AmpereF32SWKernelPresumLevel1Kernel;
