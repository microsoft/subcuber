...
using AmpereF32SWInterleavedPresumLevel1_128x128Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class AmpereF32SWInterleavedPresumLevel1_128x128 {
public:
  using StrassenGemmKernel = AmpereF32SWInterleavedPresumLevel1_128x128Kernel;
