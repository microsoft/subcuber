...
using AmpereF32SWFusedPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class AmpereF32SWFusedPresumLevel1 {
public:
  using StrassenGemmKernel = AmpereF32SWFusedPresumLevel1Kernel;
