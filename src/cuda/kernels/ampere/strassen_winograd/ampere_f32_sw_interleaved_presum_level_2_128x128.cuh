...
using AmpereF32SWInterleavedPresumLevel2_128x128Kernel = cutlass::gemm::device::StrassenGemmLevel2<StrassenKind,
...
class AmpereF32SWInterleavedPresumLevel2_128x128 {
public:
  using StrassenGemmKernel = AmpereF32SWInterleavedPresumLevel2_128x128Kernel;
