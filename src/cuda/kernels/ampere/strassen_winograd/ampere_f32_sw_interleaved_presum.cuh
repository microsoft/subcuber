...
using AmpereF32SWInterleavedPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class AmpereF32SWInterleavedPresumLevel1 {
public:
  using StrassenGemmKernel = AmpereF32SWInterleavedPresumLevel1Kernel;
