...
using HopperF64SWInterleavedPresumLevel2_128x64Kernel = cutlass::gemm::device::StrassenGemmLevel2<StrassenKind,
...
class HopperF64SWInterleavedPresumLevel2_128x64 {
public:
  using StrassenGemmKernel = HopperF64SWInterleavedPresumLevel2_128x64Kernel;
