...
using HopperF64SWInterleavedPresumLevel2_128x128Kernel = cutlass::gemm::device::StrassenGemmLevel2<StrassenKind,
...
class HopperF64SWInterleavedPresumLevel2_128x128 {
public:
  using StrassenGemmKernel = HopperF64SWInterleavedPresumLevel2_128x128Kernel;
