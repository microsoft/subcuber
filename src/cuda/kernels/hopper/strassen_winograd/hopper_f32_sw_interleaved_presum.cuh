...
using HopperF32SWInterleavedPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class HopperF32SWInterleavedPresumLevel1 {
public:
  using StrassenGemmKernel = HopperF32SWInterleavedPresumLevel1Kernel;
