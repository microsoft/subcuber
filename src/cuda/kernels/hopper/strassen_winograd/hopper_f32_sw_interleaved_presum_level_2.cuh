...
using StrassenGroups = StrassenLevel1Groups<StrassenPresum<1, 0, ThreadBlockShape,
                                                            AllPresumsKernel>,
                                            StrassenLevel1M0Group<1, level_1_idx, ThreadBlockShape, WarpShape, 5,
                                                                  RWMTypes<KeepAccums>,
                                                                  RWCTypes<CUW<0, LayoutInterim1D, LayoutNone, Expr<Plus<0>>>>,//C1 = M0
                                                                  AllPresumsM0>,
                                            StrassenLevel1M1Group<1, level_1_idx, ThreadBlockShape, WarpShape, 5,
                                                                  RWMTypes<ContinueAccums>,
                                                                  RWCTypes<CUW<0, LayoutFinal,   LayoutNone, Expr<Plus<1>>>>,//C0 = C0+M1
                                                                  AllPresumsM1To6>,
                                            StrassenLevel1M2Group<1, level_1_idx, ThreadBlockShape, WarpShape, 5,
                                                                  RWMTypes<>,
                                                                  ...
                                                                  AllPresumsM1To6>,
                                            StrassenLevel1M3Group<1, level_1_idx, ThreadBlockShape, WarpShape, 5,
                                                                  RWMTypes<>,
                                                                  ...
                                                                  AllPresumsM1To6>,
                                            StrassenLevel1M4Group<1, level_1_idx, ThreadBlockShape, WarpShape, 5,
                                                                  RWMTypes<>,
                                                                  ...
                                                                  AllPresumsM1To6>,
                                            StrassenLevel1M5Group<1, level_1_idx, ThreadBlockShape, WarpShape, 5,
                                                                  RWMTypes<>,
                                                                  ...
                                                                  AllPresumsM1To6>,
                                            StrassenLevel1M6Group<1, level_1_idx, ThreadBlockShape, WarpShape, 5,
                                                                  RWMTypes<>,
...
using HopperF32SWInterleavedPresumLevel2Kernel = cutlass::gemm::device::StrassenGemmLevel2<StrassenKind,
...
class HopperF32SWInterleavedPresumLevel2 {
public:
  using StrassenGemmKernel = HopperF32SWInterleavedPresumLevel2Kernel;
