...
using HopperF64SWFusedPresumLevel1_128x128Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
                                                        double,
                                                        RowMajor,
                                                        double,
                                                        RowMajor,
...
class HopperF64SWFusedPresumLevel1_128x128 {
public:
  using StrassenGemmKernel = HopperF64SWFusedPresumLevel1_128x128Kernel;
