...
using HopperF32SWKernelPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class HopperF32SWKernelPresumLevel1 {
public:
  using StrassenGemmKernel = HopperF32SWKernelPresumLevel1Kernel;
