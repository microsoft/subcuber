...
using VoltaF32SWKernelPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class VoltaF32SWKernelPresumLevel1 {
public:
  using StrassenGemmKernel = VoltaF32SWKernelPresumLevel1Kernel;
