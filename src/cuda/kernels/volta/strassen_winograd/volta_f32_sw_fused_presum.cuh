...
using VoltaF32SWFusedPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class VoltaF32SWFusedPresumLevel1 {
public:
  using StrassenGemmKernel = VoltaF32SWFusedPresumLevel1Kernel;
