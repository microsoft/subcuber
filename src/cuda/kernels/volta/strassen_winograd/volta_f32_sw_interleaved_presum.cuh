...
using VoltaF32SWInterleavedPresumLevel1Kernel = cutlass::gemm::device::StrassenGemm<StrassenKind, StrassenGroups, ScheduleStrassenGroups1,
...
class VoltaF32SWInterleavedPresumLevel1 {
public:
  using StrassenGemmKernel = VoltaF32SWInterleavedPresumLevel1Kernel;
