...
using VoltaF32SWInterleavedPresumLevel2Kernel = cutlass::gemm::device::StrassenGemmLevel2<StrassenKind,
...
class VoltaF32SWInterleavedPresumLevel2 {
public:
  using StrassenGemmKernel = VoltaF32SWInterleavedPresumLevel2Kernel;
